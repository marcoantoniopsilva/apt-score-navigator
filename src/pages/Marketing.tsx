      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <img 
              src="/lovable-uploads/8b287073-0305-4a43-9583-d58912b9e6f4.png" 
              alt="Imobly Logo" 
              className="w-8 h-8"
            />
      ...
      <section className="container mx-auto px-4 py-16 lg:py-24">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img 
                src={propertyDecisionHero} 
                alt="Pessoa em dúvida sobre qual imóvel escolher"
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <img 
              src={personChoosingProperty} 
              alt="Processo de decisão inteligente"
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                onClick={handleGetStarted}
                className="bg-white text-blue-900 hover:bg-blue-50 font-bold px-12 py-6 text-xl shadow-2xl"
              >
